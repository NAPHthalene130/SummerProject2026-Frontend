...
export const standardRoadSegments: RoadSegment[] = [
  ...
  { segment_id: "seg_tech_e", name: "科技大道核心路口东段", from_node: "n_c1", to_node: "n_e1", road_type: "main", length_m: 880, lane_count: 4, speed_limit: 60, camera_ids: ["cam_002"], base_risk: 0.34, status: "risk", traffic_flow: 86, avg_speed: 24, risk_score: 0.72 },
  { segment_id: "seg_innov_w", name: "创新路西段", from_node: "n_w2", to_node: "n_c2", road_type: "secondary", length_m: 820, lane_count: 3, speed_limit: 50, camera_ids: ["cam_003"], base_risk: 0.22, status: "busy", traffic_flow: 74, avg_speed: 32, risk_score: 0.48 },
  { segment_id: "seg_innov_e", name: "创新路施工拥堵段", from_node: "n_c2", to_node: "n_e2", road_type: "secondary", length_m: 830, lane_count: 3, speed_limit: 50, camera_ids: [], base_risk: 0.38, status: "busy", traffic_flow: 82, avg_speed: 26, risk_score: 0.56 },
  ...
  { segment_id: "seg_cloud_n", name: "云计算路核心北段", from_node: "n_north_c", to_node: "n_c1", road_type: "main", length_m: 430, lane_count: 4, speed_limit: 60, camera_ids: ["cam_005"], base_risk: 0.31, status: "busy", traffic_flow: 76, avg_speed: 33, risk_score: 0.5 },
  ...
  { segment_id: "seg_smart_s", name: "智能北街南段", from_node: "n_e1", to_node: "n_south_e", road_type: "branch", length_m: 1420, lane_count: 2, speed_limit: 35, camera_ids: [], base_risk: 0.23, status: "busy", traffic_flow: 64, avg_speed: 27, risk_score: 0.52 },
  { segment_id: "seg_gaoxin_1", name: "高新一路事故高发段", from_node: "n_c2", to_node: "n_e1", road_type: "main", length_m: 920, lane_count: 4, speed_limit: 50, camera_ids: ["cam_006"], base_risk: 0.52, status: "danger", traffic_flow: 112, avg_speed: 7, risk_score: 0.96 },
